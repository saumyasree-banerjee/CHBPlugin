...
class IdentifiedAuditLog extends Component {
    ...
    searchTranslationService(tokenData, state, instance) {
        ...
        if (tokenData !== "") {
            fetch(API.IDENTIFIED_AUDIT_LOG + "?RecordId=" + this.state.ShipmentId + "&RecordType=BL" ,{
                method: "GET",
                ...
                <div>
                    ...
                    <div className="grid-wrapper">
                        <div className="col-100">
                            {
                            (this.state.BLIDTitle!==null)? <div><h2>Bill of Lading: {this.state.BLIDTitle}</h2></div>:<div></div>
                        }
