...
class IdentifiedISFErrorDetails extends Component {
    constructor(props){
        super(props);
    ...
    loadBIIdentifiedTableData(){
       ...
       if(self.props.match.params.ISFRecordID!==undefined){
            self.setState({
                ShipmentID:self.props.match.params.ISFRecordID
            })
        }
    ...
    ErrorDetails(tokenData) {
        ...
        if(self.props.match.params.ISFRecordID!==undefined){
            ...
            if(self.props.match.params.Status==="DeliveredToCW1"|| self.props.match.params.Status==="DeliveredToKewill")
            {
                urlsFinal=  API.ISFDELIVERED_DOWNLOAD+ self.state.ShipmentID;
            }else if(self.props.match.params.Status==="DeliveredToKewill"){
                urlsFinal=  API.ISFDELIVERED_DOWNLOAD+ self.state.ShipmentID;
            }
            else{
                urlsFinal=API.ISFERROR_DETAIL + self.state.ShipmentID ;
            }
    ...
    render(){
        return(
            <div>
                ...
                <div>
                    {
                        (this.props.match.params.Status==='DeliveredToCW1'|| this.props.match.params.Status==="DeliveredToKewill")?
...
export default IdentifiedISFErrorDetails;